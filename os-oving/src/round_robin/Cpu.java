...
public class Cpu {
     ...
     */
    public Cpu(LinkedList<Process> cpuQueue, long maxCpuTime, Statistics statistics, EventQueue eventQueue) {
    ...
    public Process switchProcess(long clock) {
        ...
        if (this.activeProcess != null){
            ...
            if (activeProcess.getRemainingCpuTime() <= activeProcess.getTimeToNextIoOperation() && activeProcess.getRemainingCpuTime() <= this.maxCpuTime) {
            	Event processEnd = new Event(Event.END_PROCESS, clock + activeProcess.getRemainingCpuTime());
